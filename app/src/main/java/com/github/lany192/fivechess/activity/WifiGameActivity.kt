...
import com.github.lany192.fivechess.game.GameView
import com.github.lany192.fivechess.game.Player
import com.github.lany192.fivechess.net.ConnectConstants.*
import com.github.lany192.fivechess.net.ConnectedService

class WifiGameActivity : AppCompatActivity(), OnClickListener {
...
//                        Log.d(TAG, "type=" + msg.arg1)
     ...
     * 处理网络信息，更新界面
     */
    private val mRequestHandler = object : Handler(Looper.getMainLooper()) {
...
//            Log.d(TAG, "net action=" + msg.what)
    ...
    private fun initViews() {
        mGameView = binding.gameView
        mBlackName = binding.blackName
        mBlackWin = binding.blackWin
        mBlackActive = binding.blackActive
        mWhiteName = binding.whiteName
        mWhiteWin = binding.whiteWin
        mWhiteActive = binding.whiteActive
        restart = binding.restart
        rollback = binding.rollback
        requestEqual = binding.requestEqual
        fail = binding.fail
